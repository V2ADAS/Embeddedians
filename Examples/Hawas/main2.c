...
int main (void){
	...
	MSYSTICK_vDelayms(4000);

//	CarControl_Move(FORWARD, 100, 0, 70,&internal.Car_Control);
//	while (HAL_MOTOR_GetMovedDistance() <= 100);
//	CarControl_Move(BACKWARD, 30, -40, 50,&internal.Car_Control);
//	while (HAL_MOTOR_GetMovedDistance() <= 130);
//	CarControl_Move(BACKWARD, 20, 40, 50,&internal.Car_Control);
//	while (HAL_MOTOR_GetMovedDistance() <= 150);
//	CarControl_Move(BACKWARD, 20, 0, 50,&internal.Car_Control);
//	while (HAL_MOTOR_GetMovedDistance() <= 170);
//	CarControl_Move(BACKWARD, 70, -40, 50 , &internal.Car_Control);
//	while (HAL_MOTOR_GetMovedDistance() <= 220);
//	CarControl_Move(FORWARD, 30, 0, 50,&internal.Car_Control);
